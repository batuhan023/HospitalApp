...
namespace HospitalApp.Server.Services.ForAuth
{
    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<ServiceResponse<string>> Login(string email, string password)
        {
            ...
            else if (!VerifyPasswprdHash(password,user.PasswordHash, user.PasswordSalt))
            {
                response.Success = false;
        ...
        public async Task<ServiceResponse<int>> Register(User user, string password)
        {
            ...
            CreatrePasswprdHash(password, out byte[] passwordHash, out byte[] passwordSalt);
            ...
            { 
                Data = user.Id,
                Success = true,
                Message= "User created succescfully"
            };
        }

        private void CreatrePasswprdHash(string password, out byte[] passwordHash, out byte[] passwordSalt)
        {
